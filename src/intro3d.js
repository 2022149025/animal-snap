...
const CAPTIONS = [
  { t0: 0.4, t1: 4.6, tag: '🔴 BREAKING NEWS', title: '거대 소행성, 충돌 궤도 진입',
    body: '국제천문연맹 긴급 발표 — 사흘 뒤, 막을 수 없는 충돌.' },
  { t0: 5.0, t1: 9.2, tag: '⚠ 전 세계 비상', title: '하늘이 붉게 물들기 시작했다',
    body: '대기권으로 파편이 쏟아지고, 땅이 흔들린다.' },
  { t0: 9.6, t1: 15.4, tag: '📷 당신의 선택', title: '마지막 기록',
